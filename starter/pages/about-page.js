export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        <img src="/about-2.jpg" alt="Family that manages Sanctuary" />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            Over the years, we've maintained the essence of Sanctuary, blending
            ...
            part of our extended family. So join us at The Wild Oasis soon,
